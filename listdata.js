...
const priceA = parseFloat((a.querySelector('.deal-stats strong')?.innerText || '0').replace('₹','')) || 0;
    const priceB = parseFloat((b.querySelector('.deal-stats strong')?.innerText || '0').replace('₹','')) || 0;
